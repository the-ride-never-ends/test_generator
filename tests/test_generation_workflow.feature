Feature: End-to-End Test Generation Workflow
  As a developer
  I want to generate complete test files from specifications
  So that I can automate the creation of standardized test boilerplate

  Background:
    Given the test generator system is available
    And I have access to the command-line interface
